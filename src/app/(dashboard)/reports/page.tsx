...
export default function ReportsPage() {
      ...
      <body>
        <div class="header">
          <div style="margin-bottom: 20px;">
            <h2 style="margin: 0; font-size: 16px; color: #475569; text-transform: uppercase;">Ministry of Civil Aviation & Airport Development</h2>
            <p style="margin: 4px 0 0; font-size: 12px; color: #94a3b8; text-transform: uppercase; letter-spacing: 2px;">Republic of Somaliland</p>
          </div>
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20">
      {/* MOCAAD Logo Header Section */}
      <div className="flex flex-col md:flex-row items-center justify-between p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-xl overflow-hidden relative">
        ...
        <div className="flex items-center gap-6 relative z-10">
          <div className="w-20 h-20 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center border border-white/20 shadow-lg p-2">
            <img src="/logo.png" alt="MOCAAD Logo" className="w-full h-full object-contain" />
          </div>
          <div>
            ...
            <p className="text-blue-400 font-bold tracking-[0.2em] uppercase text-[10px] mt-2">
        ...
        <button
          ...
          className="mt-6 md:mt-0 relative z-10 flex items-center gap-2 px-6 py-3 bg-blue-600 text-white font-bold rounded-xl shadow-lg shadow-blue-600/20 hover:bg-blue-700 transition-all active:scale-95 border border-blue-500"
        >
