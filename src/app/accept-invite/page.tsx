      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 p-8 lg:p-12">
        ...
        {state === 'loading' && (
          <div className="text-center py-12">
            ...
            <p className="text-slate-500 font-medium">Validating your invitation...</p>
          </div>
        )}
        ...
        {state === 'expired' && (
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Invitation Expired</h3>
        ...
        {state === 'valid' && (
          <>
            ...
            <h3 className="text-2xl font-black text-slate-900 tracking-tight text-center">Set Your Password</h3>
            <p className="text-slate-500 mt-1 text-sm font-medium text-center mb-8">
              Welcome! Create a password to activate your account.
            </p>

            {/* Email display */}
            <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-2xl text-center">
              <p className="text-xs font-bold text-blue-400 uppercase tracking-widest mb-1">Your Email</p>
